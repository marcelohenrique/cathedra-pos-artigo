...
A seguir a Figura \autoref{figura-processo-mpdft-up} que desenha o fluxo de trabalho macro do processo.

\begin{figure}[htb]
   \caption{Fluxo de trabalho do MPDFT-UP.}
   \label{figura-processo-mpdft-up}
   \begin{center}
       \includegraphics[scale=0.5]{MPDFT-UP_BFB966A8_bfb966a8_Activity.jpeg}
   \end{center}
   \fonte{\citeonline{mpdft-up}}
\end{figure}

Apesar de existirem oito etapas somente seis estão detalhadas na documentação do
MPDFT-UP \cite{mpdft-up}. A etapa de entendimento inicial e de avaliação não
detalhadas.

Além das etapas anteriores alguns papéis também foram definidos na Tabela
\autoref{tabela-papeis-mpdft-up}.
