...
% ---
\titulo{Uma Visão Crítica sobre o Processo de Desenvolvimento de Software do
MPDFT}
...
\instituicao{%
  FACULDADE IMP
  \par
  Curso de Pós-Graduação Lato Sensu em Gestão da Tecnologia da Informação na Administração Pública}
\local{Brasil}
\orientador{Prof. Dr. Renato Jorge Brown Ribeiro}
% O preambulo deve conter o tipo do trabalho, o objetivo, 
% o nome da instituição e a área de concentração 
\preambulo{Trabalho de conclusão de Curso de Especialização apresentado como
requisito parcial para a obtenção de titulo de Especialista em Gestão da
Tecnologia da Informação na Administração Pública pelo Curso de Especialização
Lato Sensu da Faculdade IMP.}
% ---
...
\includepdf[pages={1,2,3}]{modelo-capa-folha-rosto-aprovacao.pdf}
